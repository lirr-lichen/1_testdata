...
do
	...
	workflowpath="/nfs/database/ngs_pipeline/snakefile-ngs_v1/"
...
echo \$(data +%F%n%T)
#${bcl2fastqpath} -i ${bcldir}/${runid}/Data/Intensities/BaseCalls/ --interop-dir ${bcldir}/${runid}/InterOp/ -R ${bcldir}/${runid} --stats-dir ${bcldir}/${runid}/Stats/ --sample-sheet  ${bcldir}/${runid}/SampleSheet.csv --barcode-mismatches 0 --no-lane-splitting -o ${outdir}/${runid}
